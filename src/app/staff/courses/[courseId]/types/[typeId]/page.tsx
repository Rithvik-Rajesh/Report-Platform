...
// Custom progress component to avoid the indicatorClassName issue
                                ...
                                <div className="border-l-4 border-green-500 pl-0">
                                    <div className="p-6">
                                            ...
                                            <TooltipProvider>
                                                <Tooltip>
                                                    <TooltipTrigger asChild>
                                                        <Badge
                                                            className={`px-3 py-1 text-sm font-medium rounded-full ${question
                                                                .difficulty ===
                                                                "Hard"
                                        ...
                                        <div className="space-y-1 mt-4">
                                            ...
                                            <CustomProgress value={question.statistics.accuracy} />
                                        </div>
                                        ...
                                        <div className="mt-6">
                                            ...
                                            <div className="space-y-2 mt-2">
                                                {question.options.map((
                                                    ...
                                                    <div
                                                        key={option.id}
                                                        className={`flex items-center p-3 rounded-lg transition-colors ${option.is_correct
                                                            ? "bg-green-50 border border-green-200"
                                                            : "bg-gray-50 border border-gray-200"
                                                            }`}
                                                    >
                                                        <div
                                                            className={`w-7 h-7 flex items-center justify-center rounded-full mr-3 ${option
                                                                .is_correct
